...
VALUES
((SELECT id FROM movie WHERE title='Inception'), (SELECT id FROM movie WHERE title='Sci-Fi')),
((SELECT id FROM movie WHERE title='Inception'), (SELECT id FROM movie WHERE title='Action')),
((SELECT id FROM movie WHERE title='The Shawshank Redemption'), (SELECT id FROM movie WHERE title='Action')),
((SELECT id FROM movie WHERE title='Pulp Fiction'), (SELECT id FROM movie WHERE title='Action'));
